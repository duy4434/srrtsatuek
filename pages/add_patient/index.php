    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">ตารางจัดการข้อมูลผู้ป่วย</h3>
          <a href="form-create.php" class="btn btn-primary float-right ">เพิ่มผู้ป่วย+</a href="form-create.php">
        </div>
        <!-- /.card-header -->
        <div class="card-body">
